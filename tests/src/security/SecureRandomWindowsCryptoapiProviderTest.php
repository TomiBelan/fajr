...
/**
 * This file contains *basic* tests for SecureRandomWindowsCryptoapiProvider
 *
 * @package    Fajr
 * @subpackage Security
 ...
 * @ignore
 */
class SecureRandomWindowsCryptoapiProviderTest extends PHPUnit_Framework_TestCase
{


  public function testLength() {
    if (!SecureRandomWindowsCryptoapiProvider::isAvailable()) {
      $this->markTestSkipped('Cryptoapi not available');
    }

    $random = new SecureRandomWindowsCryptoapiProvider();
