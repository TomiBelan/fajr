...
/**
 * This file contains *basic* tests for SecureRandomLinuxProvider
 *
 * @package    Fajr
 * @subpackage Security
 ...
 * @ignore
 */
class SecureRandomLinuxProviderTest extends PHPUnit_Framework_TestCase
{


  public function testLength() {
    if (!SecureRandomLinuxProvider::isAvailable()) {
      $this->markTestSkipped('Linux random device not available');
    }

    $random = new SecureRandomLinuxProvider();
